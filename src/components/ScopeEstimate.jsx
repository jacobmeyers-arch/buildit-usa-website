  ...
  return (
    <div className="min-h-screen bg-workshop flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-8 space-y-8">
        {/* Total cost range */}
        <div className="relative bg-brass/20 border-2 border-brass rounded-lg p-6 text-center">
          <span className="brass-nail absolute top-3 left-3" />
          <span className="brass-nail absolute top-3 right-3" />
          <span className="brass-nail absolute bottom-3 left-3" />
          <span className="brass-nail absolute bottom-3 right-3" />
          <p className="font-serif text-parchment/80 text-sm mb-2">
            Estimated Total Cost
          </p>
          <p className="font-hand text-4xl text-brass">
            ...
            <div className="space-y-2">
              {estimate.line_items.map((item, idx) => (
                <React.Fragment key={idx}>
                  {idx > 0 && <div className="wood-divider" />}
                <div
                  className="card-workshop rounded-lg p-4 space-y-2"
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="text-right">
                      <p className="font-hand text-lg text-brass whitespace-nowrap">
        ...
        {estimate.regional_note && (
          <div className="card-workshop rounded-lg p-4">
